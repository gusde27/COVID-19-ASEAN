...
public class Singapore extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle saveInstanceState){
        ...
        singapura = getActivity().findViewById(R.id.singapura);
        ...
        JsonPlaceHolderAPISingapura jsonPlace = retro.create(JsonPlaceHolderAPISingapura.class);
        ...
        call.enqueue(new Callback<List<Data>>(){
            ...
            public void onResponse(Call<List<Data>> call, Response<List<Data>> response) {
                if(!response.isSuccessful()) {
                    singapura.setText("Code : "+ response.code());
                    return;
                }
            ...
            public void onFailure(Call<List<Data>> call, Throwable t) {
                singapura.setText(t.getMessage());
            }
        });
