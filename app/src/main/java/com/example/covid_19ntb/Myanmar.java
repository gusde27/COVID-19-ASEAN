 ...
 */
public class Myanmar extends Fragment {

    private TextView myanmar;
    ...
    public void onViewCreated(View view, @Nullable Bundle saveInstanceState){
        ...
        myanmar = getActivity().findViewById(R.id.myanmar);
        ...
        JsonPlaceHolderAPIMyanmar jsonPlace = retro.create(JsonPlaceHolderAPIMyanmar.class);
        ...
        call.enqueue(new Callback<List<Data>>(){
            ...
            public void onResponse(Call<List<Data>> call, Response<List<Data>> response) {
                if(!response.isSuccessful()) {
                    myanmar.setText("Code : "+ response.code());
                    return;
                }
