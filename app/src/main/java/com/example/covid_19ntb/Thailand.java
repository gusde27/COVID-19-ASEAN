...
public class Thailand extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle saveInstanceState){
        ...
        thailand = getActivity().findViewById(R.id.thailand);
        ...
        JsonPlaceHolderAPIThailand jsonPlace = retro.create(JsonPlaceHolderAPIThailand.class);
        ...
        call.enqueue(new Callback<List<Data>>(){
            ...
            public void onResponse(Call<List<Data>> call, Response<List<Data>> response) {
                if(!response.isSuccessful()) {
                    thailand.setText("Code : "+ response.code());
                    return;
                }
